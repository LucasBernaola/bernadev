...
const experiences: Experience[] = [
  {
    name: "Freelance Web Development / 2025",
    description:
      "I work independently developing custom web applications for companies and entrepreneurs, combining functional design with solid technical solutions.",
  },
  {
